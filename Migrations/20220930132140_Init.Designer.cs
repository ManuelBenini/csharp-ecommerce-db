...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderProduct", b =>
                {
                    b.Property<int>("OrderPlacedOrderId")
                        .HasColumnType("int");

                    b.Property<int>("ProductsOrderedProductId")
                        .HasColumnType("int");

                    b.HasKey("OrderPlacedOrderId", "ProductsOrderedProductId");

                    b.HasIndex("ProductsOrderedProductId");
            ...
            modelBuilder.Entity("OrderProduct", b =>
                {
                    b.HasOne("csharp_ecommerce_db.Order", null)
                        .WithMany()
                        .HasForeignKey("OrderPlacedOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("csharp_ecommerce_db.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductsOrderedProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
